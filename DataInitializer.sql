...
-- INSERT INTO students (code, full_name, user_name, password)
-- VALUES
--   (1, 'Admin', 'admin', crypt('123456', gen_salt('bf'))),
--   (22002575, 'Trần Gia Nguyên Phong', 'phong.tgn02575',
--    crypt('123456', gen_salt('bf'))),
--   (22002581, 'Võ Thị Kim Ngân',       'ngan.vtk02581',
--    crypt('123456', gen_salt('bf'))),
--   (22002576, 'Nguyễn Văn An',          'an.nv02576',
--    crypt('123456', gen_salt('bf')));
